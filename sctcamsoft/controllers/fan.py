...
# Telnet protocol follows example at:
...
from sctcamsoft.camera_control_classes import (CommandNameError,
...
class FanController(DeviceController):
    ...
    def execute_command(self, command):
        ...
        if cmd == "open_connection":
            ...
            update = self.write_update('connected', int(self._ser is not None))
