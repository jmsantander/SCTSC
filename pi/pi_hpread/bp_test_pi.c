...
/****************************************************************************************************/
        case 'm': // display menu
			...
			printf("7. Write trigger patterns to binary file (dataword) \n");
    ...
    case '7': // Print hit pattern to binary file
      ...
      fwrite(ts.tv_nsec,sizeof(tv.tv_nsec),1, fptr); // write data to binary file
