...
// load SPI wrap around message as default
    ...
    printf("\n\n************* CTA HKFPGA Readout Test Program June 14, 2019 ***************\n");
...
/****************************************************************************************************/
		...
		case 'j': // Set Trigger Mask from file
			...
			printf(" %04x %04x %04x %04x %04x\n", j[9],j[8],j[7],j[6],j[5]);
			printf(" %04x %04x %04x %04x %04x\n", j[14],j[13],j[12],j[11],j[10]);
			printf(" %04x %04x %04x %04x %04x\n", j[19],j[18],j[17],j[16],j[15]);
			printf(" %04x %04x %04x %04x %04x\n", j[24],j[23],j[22],j[21],j[20]);
			break;
		...
		case 'q': // Display Hit Pattern
			...
			printf(" %x%x%x%x %x%x%x%x %x%x%x%x %x%x%x%x %x%x%x%x\n", 
				...
				(hit_pattern[24] & 0x2000) >>13 //
				);
				
				printf(" %x%x%x%x %x%x%x%x %x%x%x%x %x%x%x%x %x%x%x%x\n", 
				(hit_pattern[20] & 0x0001) >>0, //352
				(hit_pattern[20] & 0x0010) >>4, //356
				(hit_pattern[20] & 0x0100) >>8, //360
				(hit_pattern[20] & 0x1000) >>12, //365
				...
				(hit_pattern[24] & 0x0001) >>0, //
				(hit_pattern[24] & 0x0010) >>4, //
				(hit_pattern[24] & 0x0100) >>8, //
				(hit_pattern[24] & 0x1000) >>12 //
				);
...
void display_fees_present (void) {
	...
	// data[2] is FEEs present 0-15
	// data[3] is FEEs present 16-24

	printf("%x ",  data[2] & 0x0001);
	printf("%x ", (data[2] & 0x0002) >> 1);
	printf("%x ", (data[2] & 0x0004) >> 2);
	printf("%x ", (data[2] & 0x0008) >> 3);
	printf("%x ", (data[2] & 0x0010) >> 4);
	printf("\n");
	printf("%x ", (data[2] & 0x0020) >> 5);
	printf("%x ", (data[2] & 0x0040) >> 6);
	printf("%x ", (data[2] & 0x0080) >> 7);
	printf("%x ", (data[2] & 0x0100) >> 8);
	printf("%x ", (data[2] & 0x0200) >> 9);
	printf("\n");
	printf("%x ", (data[2] & 0x0400) >> 10);
	printf("%x ", (data[2] & 0x0800) >> 11);
	printf("%x ", (data[2] & 0x1000) >> 12);
	printf("%x ", (data[2] & 0x2000) >> 13);
	printf("%x ", (data[2] & 0x4000) >> 14);
	printf("\n");
	printf("%x ", (data[2] & 0x8000) >> 15);
	printf("%x ",  data[3] & 0x0001);
	printf("%x ", (data[3] & 0x0002) >> 1);
	printf("%x ", (data[3] & 0x0004) >> 2);
	printf("%x ", (data[3] & 0x0008) >> 3);
	printf("\n");
	printf("%x ", (data[3] & 0x0010) >> 4);
	printf("%x ", (data[3] & 0x0020) >> 5);
	printf("%x ", (data[3] & 0x0040) >> 6);
	printf("%x ", (data[3] & 0x0080) >> 7);
	printf("%x ", (data[3] & 0x0100) >> 8);
	printf("\n");
	
	// data[5] is FEE Power ON/OFF status 0-15
	// data[4] is FEE Power ON/OFF status 16-24
	return;
}
...
void display_voltages (void) {
	...
	voltsarray[6] = data[3];
	voltsarray[1]  = data[4];
	voltsarray[10] = data[5];
	voltsarray[2]  = data[6];
	voltsarray[7] = data[7];
	voltsarray[5] = data[8];
	voltsarray[11] = data[9];
		
	tdelay(10);
	spi_message[1] = CW_RD_ENV; //cw
	transfer_message(spi_message,data);
	
	voltsarray[24]  = data[5];
	...
	voltsarray[16] = data[3];
	voltsarray[22] = data[4];
	voltsarray[15] = data[5];
	voltsarray[23] = data[6];
	voltsarray[21] = data[7];
	voltsarray[18] = data[8];
	voltsarray[17] = data[9];
	
	tdelay(10);
	spi_message[1] = CW_RD_FEE24_V; //cw
	transfer_message(spi_message,data);
	
    voltsarray[13] = data[2];
	voltsarray[3]  = data[3];
	voltsarray[19] = data[4];
	voltsarray[9] = data[5];
	voltsarray[4]  = data[6];
	voltsarray[12] = data[7];
	voltsarray[14] = data[8];
	voltsarray[8] = data[9];
...
void display_currents (void) {
    ...
    currentarray[0]  = data[2];
	currentarray[6] = data[3];
	currentarray[1]  = data[4];
	currentarray[10] = data[5];
	currentarray[2]  = data[6];
	currentarray[7] = data[7];
	currentarray[5] = data[8];
	currentarray[11] = data[9];
	
	tdelay(10);
	spi_message[1] = CW_RD_ENV; //cw
	transfer_message(spi_message,data);

	currentarray[24]  = data[4];
	...
	currentarray[16] = data[3];
	currentarray[22] = data[4];
	currentarray[15] = data[5];
	currentarray[23] = data[6];
	currentarray[21] = data[7];
	currentarray[18] = data[8];
	currentarray[17] = data[9];
	
	tdelay(10);
	spi_message[1] = CW_RD_FEE24_I; //cw
	transfer_message(spi_message,data);
	
    currentarray[13] = data[2];
	currentarray[3]  = data[3];
	currentarray[19] = data[4];
	currentarray[9] = data[5];
	currentarray[4]  = data[6];
	currentarray[12] = data[7];
	currentarray[14] = data[8];
	currentarray[8] = data[9];	
